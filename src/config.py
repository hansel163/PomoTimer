...
class TimerConfig(object):
    def __init__(self, cfg_file=CONFIG_FILE):
        ...
        self.timer_alarm_sound_file = u"res/sound/beep0.wav"
    ...
    def read_config_file(self, cfg_file):
        ...
        try:
            ...
            self.timer_alarm_sound_file = config.get(
                SECTION_ALARM,
                ALARM_SOUND_FILE, fallback=u"res/sound/beep0.wav")
    ...
    def save_config_file(self, cfg_file):
        ...
        config.set(SECTION_ALARM, ALARM_SOUND_FILE, self.timer_alarm_sound_file)
        config.set(
            SECTION_ALARM, ALARM_NOTIFICATION,
            str(self.timer_alarm_notification))

        config.set(SECTION_ALARM, ALARM_DURATION, str(self.timer_alarm_duration))
        try:
